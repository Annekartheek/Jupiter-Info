...
export function Gallery() {
  const images = [
    ...
    {
      url: "https://assets.science.nasa.gov/dynamicimage/assets/science/psd/solar/2023/09/2/204_PIA19048.jpg?w=4096&format=jpeg&fit=clip&crop=faces%2Cfocalpoint",
